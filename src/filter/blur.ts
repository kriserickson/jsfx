namespace jsfx.filter {
    ...
    export class Blur extends Filter {
        ...
        public drawWebGL(renderer: jsfx.webgl.Renderer) {
            ...
            const firstPass = {delta: [this.properties.radius / renderer.getSource().width, 0]};
            const secondPass = {delta: [0, this.properties.radius / renderer.getSource().height]};
        ...
        public drawCanvas(renderer: jsfx.canvas.Renderer): void {
            ...
            let stackIn: BlurStack = null;
            let stackOut: BlurStack = null;
